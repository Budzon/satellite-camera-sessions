...
namespace OptimalChain
{
    public class Graph
    {
        ...
        public List<MPZ> findOptimalChain()
        {
                            ...
                            else
                            {
                                        ...
                                        else
                                        {
                                            if (lastMPZ.end.AddMilliseconds(Constants.MPZ_delta) < v.s.dateFrom)
                                            {
                                              //  Console.WriteLine("New MPZ");
                                                ...
                                                v.path = e.v1.path.ToList();
                                                int N = v.path.Count;
                                                v.path.Add(new MPZ(N, new Route(v.s)));
                                            }
                                        }
                                ...
                                else
                                {
                                   // Console.WriteLine("START");
                                    v.mark = mark_new;
                                    v.path.Add(new MPZ(0, new Route(v.s)));
                                }
                            }
