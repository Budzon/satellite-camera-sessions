...
namespace ViewModel
{
    ...
    public class EarthSatelliteViewModel : INotifyPropertyChanged
    {
        ...
        void testbd()
        {
            ...
            TrajectoryPoint? point = fetcher.GetSingleTragectoryPoint(dtx);
        ...
        public void test_calculatePitchArray()
        {
            ...
            Trajectory trajectory = fetcher.GetTrajectorySat(dt1, dt2);
            TrajectoryPoint pp1 = (TrajectoryPoint)fetcher.GetSingleTragectoryPoint(dtMid);
        ...
        public void testGetSegmentStrip()
        {
            ...
            TrajectoryPoint pp1 = (TrajectoryPoint)fetcher.GetSingleTragectoryPoint(DateTime.Parse("01.02.2019 0:15:00"));
        ...
        public void testTrapezium()
        {
            ...
            Console.WriteLine(WktTestingTools.getWKTStrip(trajectory, rollAngle, 5));
            Console.Write(",");
    ...
    , 356
        ...
        {
            DateTime dt1 = DateTime.Parse("07/01/2019 00:00:00");
            DateTime dt2 = DateTime.Parse("17/01/2019 00:00:00");
            ...
            string corydor_pol = "POLYGON((-71.69508360140024 -33.24668916461695, -71.69640540657565 -33.25302008439956, -71.6855907398276 -33.25359429479964, -71.67323112068698 -33.26364236595113, -71.67151450691745 -33.27512446058385, -71.65280341682957 -33.29908846719213, -71.65211677132176 -33.3381055723356, -71.64353370247409 -33.33867922296974, -71.64147376595066 -33.328639791414396, -71.64181708870456 -33.30956168429292, -71.64387702522801 -33.292631747864434, -71.65503501472995 -33.27928634703817, -71.66516303597018 -33.26938360198317, -71.6655578445643 -33.25989600597201, -71.68409727327524 -33.24554064929845, -71.69508360140024 -33.24668916461695))";
            ...
            RequestParams coridor_rp = new RequestParams(_id: 0, _priority: 3, _timeFrom: dt1, _timeTo: dt2, _Max_SOEN_anlge: AstronomyMath.ToRad(45), _minCoverPerc: 0.4, _Max_sun_angle: 1, _Min_sun_angle:  1,
                _wktPolygon: corydor_pol, _shootingType: 2, _compression: 6);
    ...
    , out sessions);
        ...
        //    string cs = System.IO.File.ReadLines("DBstring.conf").First();
        //    DIOS.Common.SqlManager managerDB = new DIOS.Common.SqlManager(cs);
        //    //DBTables.DataFetcher fetcher33 = new DBTables.DataFetcher(managerDB);
        //    //List<TimePeriod> shadowPeriods;
        //    //List<Tuple<int, List<wktPolygonLit>>> partsLitAndNot;
        //    ////Sessions.checkIfViewLaneIsLitWithTimeSpans(managerDB, DateTime.Parse("01/01/2013 08:45:00"), DateTime.Parse("12/05/2018 08:46:00"), out partsLitAndNot, out shadowPeriods);
        //    ////var p = fetcher33.GetSingleTragectoryPoint(DateTime.Parse("24/04/2018 08:45:00"));\
        //    //fetcher33.GetTrajectorySat(DateTime.Parse("01/01/2000 08:45:00"), DateTime.Parse("12/05/2000 08:46:00"));
        ...
        //    string corydor_pol = "POLYGON((30.47909523546696 31.50893714316487, 30.704314962029454 31.565119176562845, 30.951507344841957 31.61658966037413, 31.176727071404457 31.61658966037413, 31.67660500109196 31.551076837990692, 32.05014015734196 31.45272131847983, 32.41268898546696 31.288565804531615, 32.56649757921696 31.062972814547564, 32.63241554796696 30.794384750646714, 32.78073097765446 30.685793816633435, 32.85214211046696 30.883997903877116, 32.747771993279464 31.08179274516506, 32.59396339952946 31.3448799933865, 32.302825704216964 31.51362027038627, 31.824920430779457 31.649328794374384, 31.423919454216957 31.72879011682413, 31.00094582140446 31.7381340336631, 30.59994484484196 31.630622128844422, 30.47909523546696 31.50893714316487))";
        ...
        //    //      DateTime startsss = DateTime.Parse("02.02.2019 08:00:00");
        //    //      List<CoridorParams> coridorParams;
        //    //   Sessions.getPiecewiseCoridorParams(startsss, new Polygon(corydor_pol).getCenterLine(), managerDB, out coridorParams, 3.5e5);
        ...
        //    //Console.WriteLine(Polygon.getMultipolFromPolygons(allPols));
        //    //Console.Write(",");
        //    //Console.WriteLine(WktTestingTools.getWKTTrajectory(trajectory2));
        //    //Console.Write(",");
