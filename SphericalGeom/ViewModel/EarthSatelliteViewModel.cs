    ...
    public class EarthSatelliteViewModel : INotifyPropertyChanged
    {
        ...
        public void test_isRequestFeasible()
        {
           //// if (curRequest == null)
            ...
            reqparams.wktPolygon = "POLYGON ((-113.764907086389 -71.6641725347765,-114.703258729311 -73.7321335437221,-114.967475029244 -75.2364102818017,-113.47894737438 -80.7088581215486,-110.993629388334 -81.9999923903653,-107.14406801539 -77.5957832536539,-107.191638633638 -74.1650985497303,-108.579254377056 -71.2234972087057,-113.764907086389 -71.6641725347765))";// pol.ToWtk();            
        ...
        public IList<CaptureConf> test_getCaptureConfArray()
        {
         ...
         /*   polygons.Add(new Polygon("POLYGON ((-78.8955984362672 -4.27544586717168,-77.2982435684835 -8.80701993693518,-76.0355707731791 -9.91258542782664,-78.8955984362672 -4.27544586717168))"));
            ...
            */
            ...
            DateTime dt1 = new DateTime(2019, 2, 2);
            DateTime dt2 = new DateTime(2019, 2, 3);
